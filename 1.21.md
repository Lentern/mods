...
# Mods
* [3D Skin Layers](https://modrinth.com/mod/3dskinlayers) - 1.20.6 ✔ 1.21 ✔ 1.21.1 ✔
  * **Quality-of-life mod**
  * Makes the second layer of a skin render in 3D
* [Better Ping Display](https://modrinth.com/mod/better-ping-display-fabric) - 1.20.6 ✔ 1.21 ✔ 1.21.1 ✔
  * **Quality-of-life mod**
  * Changes player list (tab list) to show ping numbers instead of ping bars
* [Better Statistics Screen](https://modrinth.com/mod/better-stats) - 1.20.6 ✔ 1.21 ✔ 1.21.1 ✔
  * **Quality-of-life mod**
...
* [Capes](https://modrinth.com/mod/capes/versions) - 1.20.6 ✔ 1.21 ✔ 1.21.1 ✔
  * **Quality-of-life mod**
  * Improves the Minecraft chat with features like longer chat history
  * **Requires Fabric API & Fabric Language Kotlin**
* [Chat Patches](https://modrinth.com/mod/chatpatches) - 1.20.6 ✔ 1.21 ✔ 1.21.1 ❌
  * **Quality-of-life mod**
  * Allows you to view your cape from mods like OptiFine
  * **Requires Fabric API & YetAnotherConfigLib**
* [Concentration](https://modrinth.com/mod/concentration) - 1.20.6 ✔ 1.21 ✔ 1.21.1 ✔
  * **Quality-of-life mod**
  * Makes your fullscreen window borderless
* [Concurrent Chunk Management Engine](https://modrinth.com/mod/c2me-fabric) - 1.20.6 ✔ 1.21 ✔ 1.21.1 ✔
  * **Performance mod**
  * Improves the efficiency of chunk generation
* [Continuity](https://modrinth.com/mod/continuity) - 1.20.6 ✔ 1.21 ✔ 1.21.1 ✔
  * **Quality-of-life mod**
  ...
  * **Requires Fabric API**
* [Debugify](https://modrinth.com/mod/debugify) - 1.20.6 ✔ 1.21 ✔ 1.21.1 ❌
  * **Quality-of-life mod**
  * Patches a bunch of unpatched bugs in vanilla Minecraft
  * **Requires Fabric API**
* [Dynamic FPS](https://modrinth.com/mod/dynamic-fps) - 1.20.6 ✔ 1.21 ✔ 1.21.1 ✔
  * **Performance mod**
  ...
  * **Requires Fabric API**
* [Enhanced Block Entities](https://modrinth.com/mod/ebe) - 1.20.6 ✔ 1.21 ✔ 1.21.1 ❌
  * **Performance mod**
  ...
  * **Requires Fabric API**
* [Entity Culling](https://modrinth.com/mod/entityculling) - 1.20.6 ✔ 1.21 ✔ 1.21.1 ✔
  * **Performance mod**
  * Makes the game not render entites you can't see to improve FPS
  * **Requires Fabric API**
* [FerriteCore](https://modrinth.com/mod/ferrite-core) - 1.20.6 ✔ 1.21 ✔ 1.21.1 ✔
  * **Performance mod**
  * Reduces the game's memory usage
* [Gamma Utils](https://modrinth.com/mod/gamma-utils/versions) - 1.20.6 ✔ 1.21 ✔ 1.21.1 ✔
  * **Quality-of-life mod**
...
* [ImmediatelyFast](https://modrinth.com/mod/immediatelyfast) - 1.20.6 ✔ 1.21 ✔ 1.21.1 ✔
  * **Performance mod**
  * Makes the game's FPS higher
* [In-Game Account Switcher](https://modrinth.com/mod/in-game-account-switcher) - 1.20.6 ✔ 1.21 ✔ 1.21.1 ❌
  * **Quality-of-life mod**
  * Allows you to switch between Minecraft account without restarting the game
  * **Requires Fabric API**
* [Iris Shaders](https://modrinth.com/mod/iris) - 1.20.6 ✔ 1.21 ✔ 1.21.1 ✔
  * **Quality-of-life mod**
  * Adds support for shader packs, just like OptiFine
  * **Requires Sodium**
* [kennytvs-epic-force-close-loading-screen-mod-for-fabric](https://modrinth.com/mod/forcecloseworldloadingscreen) - 1.20.6 ✔ 1.21 ✔ 1.21.1 ✔
  * **Quality-of-life mod**
  * Closes the "Loading terrain" and resource pack switching screens faster
* [Krypton](https://modrinth.com/mod/krypton) - 1.20.6 ✔ 1.21 ✔ 1.21.1 ❌
  * **Performance mod**
  * Improves performance internally in [magical ways](https://github.com/astei/krypton/wiki)
* [Language Reload](https://modrinth.com/mod/language-reload) - 1.20.6 ✔ 1.21 ✔ 1.21.1 ✔
  * **Quality-of-life mod**
  * Adds a great-looking GUI for switching languages and makes switching them instantaneous
  * **Requires Fabric API**
* [Lithium](https://modrinth.com/mod/lithium) - 1.20.6 ✔ 1.21 ✔ 1.21.1 ✔
  * **Performance mod**
  * Improves performance of features like mob AI, game physics, and more internal stuff without changing vanilla gameplay
* [Memory Leak Fix](https://modrinth.com/mod/memoryleakfix) - 1.20.6 ✔ 1.21 ❌ 1.21.1 ❌
  * **Performance mod**
  * Fixes memory leaks
* [MiniHUD](https://www.curseforge.com/minecraft/mc-mods/minihud) - 1.20.6 ✔ 1.21 ✔ 1.21.1 ❌ ([1.21+ versions linked here](https://github.com/sakura-ryoko/minihud/releases))
  * **Quality-of-life mod**
  * Adds a mini F3 menu that you can add your own information to
  * **Requires MaLiLib**
* [Mod Menu](https://modrinth.com/mod/modmenu) - 1.20.6 ✔ 1.21 ✔ 1.21.1 ✔
  * **Quality-of-life mod**
  * Adds an in-game list of every loaded mod and allows you to configure the settings of mods
* [Model Gap Fix](https://modrinth.com/mod/modelfix) - 1.20.6 ✔ 1.21 ✔ 1.21.1 ❌
  * **Quality-of-life mod**
  * Fixes [the little pixel-wide gaps](https://bugs.mojang.com/browse/MC-73186) in items and blocks in the game
  * **Requires Fabric API**
* [ModernFix](https://modrinth.com/mod/modernfix) - 1.20.6 ✔ 1.21 ✔ 1.21.1 ✔
  * **Performance mod**
  * Fixes bugs and mproves the resource usaage and framerate of the game in many ways
* [More Culling](https://modrinth.com/mod/moreculling) - 1.20.6 ✔ 1.21 ✔ 1.21.1 ✔
  * **Performance mod**
...
* [No Chat Reports](https://modrinth.com/mod/no-chat-reports) - 1.20.6 ✔ 1.21 ✔ 1.21.1 ✔
  * **Quality-of-life mod**
  * Removes signatures from your chat messages to make them unreportable and disables in-game telemetry (data collection)
* [Nvidum](https://modrinth.com/mod/nvidium) - 1.20.6 ✔ 1.21 ✔ 1.21.1 ✔
  * **Performance mod**
  ...
  * **Requires Sodium**
* [Reese's Sodium Options](https://modrinth.com/mod/reeses-sodium-options) - 1.20.6 ✔ 1.21 ✔ 1.21.1 ✔
  * **Quality-of-life mod**
  * Reorganizes the Sodium mod's video settings menu
  * **Requires Sodium**
* [Replay Mod](https://www.replaymod.com/) - 1.20.6 ✔ 1.21 ✔ 1.21.1 ❌
  * **Quality-of-life mod**
...
* [Screenshot to Clipboard](https://modrinth.com/mod/screenshot-to-clipboard) - 1.20.6 ✔ 1.21 ✔ 1.21.1 ✔
  * **Quality-of-life mod**
...
* [Sodium](https://modrinth.com/mod/sodium) - 1.20.6 ✔ 1.21 ✔ 1.21.1 ✔
  * **Performance mod**
  * Improves your game's FPS by an order of magnitude
* [WorldEdit](https://www.curseforge.com/minecraft/mc-mods/worldedit) - 1.20.6 ✔ 1.21 ✔ 1.21.1 ✔
  * **Quality-of-life mod**
  * Edit massive areas of terrain and make massive structures
* [Zoomify](https://modrinth.com/mod/zoomify/versions) - 1.20.6 ✔ 1.21 ✔ 1.21.1 ❌
  * **Quality-of-life mod**
...
* [Cloth Config API](https://modrinth.com/mod/cloth-config) - 1.20.6 ✔ 1.21 ✔ 1.21.1 ✔
  * **Dependency mod**
  * Required for a lot of mods to be configured
* [Fabric API](https://modrinth.com/mod/fabric-api) - 1.20.6 ✔ 1.21 ✔ 1.21.1 ✔
  * **Dependency mod**
...
* [Indium](https://modrinth.com/mod/indium/versions) - 1.20.6 ✔ 1.21 ✔ 1.21.1 ✔
  * **Dependency mod**
...
* [MaLiLib](https://www.curseforge.com/minecraft/mc-mods/malilib) - 1.20.6 ✔ 1.21 ✔ 1.21.1 ❌ ([1.21+ versions linked here](https://github.com/sakura-ryoko/malilib/releases))
  * **Dependency mod**
  * Makes other mods by [the author of this mod](https://github.com/maruohon) work
* [TCDCommons API](https://modrinth.com/mod/tcdcommons) - 1.20.6 ✔ 1.21 ✔ 1.21.1 ✔
  * **Dependency mod**
  * An API for custom GUIs
  * **Requires Fabric API**
* [YetAnotherConfigLib](https://modrinth.com/mod/yacl) - 1.20.6 ✔ 1.21 ✔ 1.21.1 ❌
  * **Dependency mod**
  * Edit massive areas of terrain and make massive structures
  * **Requires Fabric API**
...
* [Technopig](https://modrinth.com/mod/technomodel) - 1.20.6 ✔ 1.20 ✔ 1.21.1 ✔
  * **Great mod**
