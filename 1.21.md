...
* [Entity Culling](https://modrinth.com/mod/entityculling) - 1.20.6 ✔ 1.21 ✔
  ...
  * **Requires Quilted Fabric API**
* [Fabric API]([https://modrinth.com/mod/fabric-language-kotlin](https://modrinth.com/mod/fabric-api)
  * **Dependency mod**
...
* [MaLiLib](https://www.curseforge.com/minecraft/mc-mods/malilib) - 1.20.6 ✔ 1.21 ❌
  * **Dependency mod**
...
* [Memory Leak Fix](https://modrinth.com/mod/memoryleakfix) - 1.20.6 ✔ 1.21 ❌
  * **Performance mod**
  * Fixes memory leaks
* [MiniHUD](https://www.curseforge.com/minecraft/mc-mods/minihud) - 1.20.6 ✔ 1.21 ❌
  * **Quality-of-life mod**
