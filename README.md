...
# Mods
* [3D Skin Layers](https://modrinth.com/mod/3dskinlayers) - 1.19.4 ✔ 1.20.1 ✔
  * **Quality-of-life mod**
...
* [Continuity](https://modrinth.com/mod/continuity) - 1.19.4 ✔ 1.20.1 ✔
  ...
  * **Requires Quilted Fabric API**
* [Dynamic FPS](https://modrinth.com/mod/dynamic-fps) - 1.19.4 ✔ 1.20.1 ✔
  * **Performance mod**
...
* [Enhanced Block Entities](https://modrinth.com/mod/ebe) - 1.19.4 ✔ 1.20.1 ✔
  ...
  * **Requires Quilted Fabric API**
* [Entity Culling](https://modrinth.com/mod/entityculling) - 1.19.4 ✔ 1.20.1 ✔
  * **Performance mod**
  * Makes the game not render entites you can't see to improve FPS
  * **Requires Quilted Fabric API**
* [Fabric Language Kotlin](https://modrinth.com/mod/fabric-language-kotlin) - 1.19.4 ✔ 1.20.1 ✔
  * **Dependency mod**
  * Adds support for Kotlin programming language for mods to use
* [FerriteCore](https://modrinth.com/mod/ferrite-core) - 1.19.4 ✔ 1.20.1 ✔
  * **Performance mod**
  * Reduces the game's memory usage
* [FiveOneFourOneEight](https://modrinth.com/mod/fiveonefouroneeight) - 1.19.4 ✔ 1.20.1 ✔ ([1.20 temporary download here](https://github.com/Lentern/FiveOneFourOneEight/releases/tag/v1.0.1))
  * **Quality-of-life mod**
...
* [ImmediatelyFast](https://modrinth.com/mod/immediatelyfast) - 1.19.4 ✔ 1.20.1 ✔
  * **Performance mod**
  * Makes the game's FPS higher
* [In-Game Account Switcher](https://modrinth.com/mod/in-game-account-switcher) - 1.19.4 ✔ 1.20.1 ✔
  * **Quality-of-life mod**
  * Allows you to switch between Minecraft account without restarting the game
  * **Requires Quilted Fabric API**
* [Indium](https://modrinth.com/mod/indium/versions) - 1.19.4 ✔ 1.20.1 ✔
  * **Dependency mod**
...
* [Iris](https://modrinth.com/mod/iris) - 1.19.4 ✔ 1.20.1 ✔
  * **Quality-of-life mod**
  * Adds support for shader packs, just like OptiFine
  * **Requires Sodium**
* [Krypton](https://modrinth.com/mod/krypton) - 1.19.4 ✔ 1.20.1 ✔
  * **Performance mod**
  * Improves performance internally in [magical ways](https://github.com/astei/krypton/wiki)
* [Language Reload](https://modrinth.com/mod/language-reload) - 1.19.4 ✔ 1.20.1 ✔
  * **Quality-of-life mod**
...
* [Lithium](https://modrinth.com/mod/lithium) - 1.19.4 ✔ 1.20.1 ✔
  * **Performance mod**
...
* [MiniHUD](https://www.curseforge.com/minecraft/mc-mods/minihud) - 1.19.4 ✔ 1.20.1 ✔
  ...
  * **Requires MaLiLib**
* [MixinTrace](https://modrinth.com/mod/mixintrace) - 1.19.4 ✔ 1.20.1 ✔
  * **Quality-of-life mod**
  * Makes crash reports more verbose
* [Mod Menu](https://modrinth.com/mod/modmenu) - 1.19.4 ✔ 1.20.1 ✔
  * **Quality-of-life mod**
  * Adds an in-game list of every loaded mod and allows you to configure the settings of mods
* [More Chat History](https://modrinth.com/mod/morechathistory) - 1.19.4 ✔ 1.20.1 ✔
  * **Quality-of-life mod**
...
* [Sodium Occlusion Culling Fix](https://modrinth.com/mod/occlusion-culling-fix-sodium) - 1.19.4 ✔ 1.20.1 ✔
  * **Quality-of-life mod**
