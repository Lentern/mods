...
- [Auto Reconnect Reforged](https://modrinth.com/mod/autoreconnectrf)
  - 1.21.1 ✔ 1.21.11 ✔ 26.1.2 ✔ 26.2 ✔ Fabric ✔ NeoForge ✔
  - Automatically reconnects you to a server when you get disconnected
  - **Requires Fabric API**
  - **New addition to the mod list since the most recent video**
- [Better Mount HUD](https://modrinth.com/mod/better-mount-hud)
  ...
  - **New addition to the mod list since the most recent video**
- [Better Ping Display](https://modrinth.com/mod/better-ping-display-fabric) **(use [Ping Display](https://modrinth.com/mod/ping-display) for Fabric 26.x+, NeoForge not available for 26.x+ yet)**
  - 1.21.1 ✔ 1.21.11 ✔ 26.1.2 ✔ 26.2 ✔ Fabric ✔ [NeoForge](https://modrinth.com/mod/better-ping-display) ✔
...
- [Better Statistics Screen](https://modrinth.com/mod/better-stats)
  - 1.21.1 ✔ 1.21.11 ✔ 26.1.2 ✔ 26.2 ✔ Fabric ✔ NeoForge (1.21.8+) ✔
...
- [Gamma Utils](https://modrinth.com/mod/gamma-utils)
  - 1.21.1 ✔ 1.21.11 ✔ 26.1.2 ✔ 26.2 ✔ Fabric ✔ NeoForge (26.1+) ✔
...
- [Cupboard](https://www.curseforge.com/minecraft/mc-mods/cupboard)
  - 1.21.1 ✔ 1.21.11 ✔ 26.1.2 ✔ 26.2 ✔ Fabric ✔ NeoForge ✔ **(26.1 only on NeoForge currently)**
  - Adds frameworks for other mods
  - **New addition to the mod list since the most recent video**
- [Fabric API](https://modrinth.com/mod/fabric-api)
  - 1.21.1 ✔ 1.21.11 ✔ 26.1.2 ✔ 26.2 ✔ Fabric ✔ [NeoForge](https://modrinth.com/mod/forgified-fabric-api) (for 1.21.1) ✔
