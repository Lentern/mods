...
* [Blanket](https://modrinth.com/mod/blanket) - 1.19.4 ✔* 1.20.6 ❌
...
* [Continuity](https://modrinth.com/mod/continuity) - 1.19.4 ✔ 1.20.6 ✔
  ...
  * **Requires Quilted Fabric API**
* [Dynamic FPS](https://modrinth.com/mod/dynamic-fps) - 1.19.4 ✔ 1.20.6 ✔
  * **Performance mod**
...
* [Enhanced Block Entities](https://modrinth.com/mod/ebe) - 1.19.4 ✔ 1.20.6 ❌
  ...
  * **Requires Quilted Fabric API**
* [Entity Culling](https://modrinth.com/mod/entityculling) - 1.19.4 ✔ 1.20.6 ✔
  * **Performance mod**
  * Makes the game not render entites you can't see to improve FPS
  * **Requires Quilted Fabric API**
* [Fabric Language Kotlin](https://modrinth.com/mod/fabric-language-kotlin) - 1.19.4 ✔ 1.20.6 ✔
  * **Dependency mod**
  * Adds support for Kotlin programming language for mods to use
* [FerriteCore](https://modrinth.com/mod/ferrite-core) - 1.19.4 ✔ 1.20.6 ✔
  * **Performance mod**
...
* [ImmediatelyFast](https://modrinth.com/mod/immediatelyfast) - 1.19.4 ✔ 1.20.6 ✔
  * **Performance mod**
  * Makes the game's FPS higher
* [In-Game Account Switcher](https://modrinth.com/mod/in-game-account-switcher) - 1.19.4 ✔ 1.20.6 ✔
  * **Quality-of-life mod**
  * Allows you to switch between Minecraft account without restarting the game
  * **Requires Quilted Fabric API**
* [Indium](https://modrinth.com/mod/indium/versions) - 1.19.4 ✔ 1.20.6 ✔
  * **Dependency mod**
...
* [Iris](https://modrinth.com/mod/iris) - 1.19.4 ✔ 1.20.6 ✔
  * **Quality-of-life mod**
...
* [Lithium](https://modrinth.com/mod/lithium) - 1.19.4 ✔ 1.20.6 ✔
  * **Performance mod**
...
* [MiniHUD](https://www.curseforge.com/minecraft/mc-mods/minihud) - 1.19.4 ✔ 1.20.6 ❌
  ...
  * **Requires MaLiLib**
* [MixinTrace](https://modrinth.com/mod/mixintrace) - 1.19.4 ✔ 1.20.6 ✔
  * **Quality-of-life mod**
  * Makes crash reports more verbose
* [Mod Menu](https://modrinth.com/mod/modmenu) - 1.19.4 ✔ 1.20.6 ✔
  * **Quality-of-life mod**
  * Adds an in-game list of every loaded mod and allows you to configure the settings of mods
* [More Chat History](https://modrinth.com/mod/morechathistory) - 1.19.4 ✔ 1.20.6 ✔
  * **Quality-of-life mod**
  * Increases the maximum amount of chat messages you can see in your chat history from 100 to 16384
* [No Chat Reports](https://modrinth.com/mod/no-chat-reports) - 1.19.4 ✔ 1.20.6 ✔
  * **Quality-of-life mod**
...
* [Reese's Sodium Options](https://modrinth.com/mod/reeses-sodium-options) - 1.19.4 ✔ 1.20.6 ✔
  * **Quality-of-life mod**
...
* [Sodium](https://modrinth.com/mod/sodium) - 1.19.4 ✔ 1.20.6 ✔
  * **Performance mod**
...
* [Technopig](https://modrinth.com/mod/technomodel) - 1.19.4 ✔ 1.20.6 ✔
  * **Great mod**
...
* [Unofficial Sodium Biome Blending Fix](https://modrinth.com/mod/unofficial-sodium-biome-blending-fix) - 1.19.4 ✔ 1.20.1 ✔ **(not necessary in Sodium 0.5 and above)**
  ...
  * **Requires Sodium**
* [WorldEdit](https://www.curseforge.com/minecraft/mc-mods/worldedit) - 1.19.4 ✔ 1.20.6 ✔
  * **Quality-of-life mod**
