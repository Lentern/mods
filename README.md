...
- [Capes](https://modrinth.com/mod/capes) - 1.20.6 ✔ 1.21.4 ✔ 1.21.5 ✔
  - **Quality-of-life mod**
  - It lets you use capes from Optifine, LabyMod, and the MinecraftCapes Mod
  - **Requires Fabric API & Fabric Language Kotlin**
- [Chat Patches](https://modrinth.com/mod/chatpatches) - 1.20.6 ✔ 1.21.4 ✔ 1.21.5 ✔
  - **Quality-of-life mod**
  - Allows you to view your cape from mods like OptiFine
  - **Requires Fabric API & YetAnotherConfigLib**
- [Concentration](https://modrinth.com/mod/concentration) - 1.20.6 ✔ 1.21.4 ✔ 1.21.5 ✔
  - **Quality-of-life mod**
...
- [Continuity](https://modrinth.com/mod/continuity) - 1.20.6 ✔ 1.21.4 ✔ 1.21.5 ✔
  ...
  - **Requires Fabric API**
- [Debugify](https://modrinth.com/mod/debugify) - 1.20.6 ✔ 1.21.4 ✔ 1.21.5 ✔
  - **Quality-of-life mod**
...
- [Gamma Utils](https://modrinth.com/mod/gamma-utils) - 1.20.6 ✔ 1.21.4 ✔ 1.21.5 ✔
  - **Quality-of-life mod**
...
- [In-Game Account Switcher](https://modrinth.com/mod/in-game-account-switcher) - 1.20.6 ✔ 1.21.4 ✔ 1.21.5 ✔
  - **Quality-of-life mod**
...
- [Iris Shaders](https://modrinth.com/mod/iris) - 1.20.6 ✔ 1.21.4 ✔ 1.21.5 ✔
  ...
  - **Requires Sodium**
- [kennytvs-epic-force-close-loading-screen-mod-for-fabric](https://modrinth.com/mod/forcecloseworldloadingscreen) - 1.20.6 ✔ 1.21.4 ✔ 1.21.5 ✔
  - **Quality-of-life mod**
...
- [Language Reload](https://modrinth.com/mod/language-reload) - 1.20.6 ✔ 1.21.4 ✔ 1.21.5 ✔
  - **Quality-of-life mod**
...
- [MiniHUD](https://github.com/sakura-ryoko/minihud/releases) - 1.20.6 ✔ 1.21.4 ✔ 1.21.5 ✔ ([1.20.6 and other old versions linked here](https://www.curseforge.com/minecraft/mc-mods/minihud))
  ...
  - **Requires MaLiLib**
- [Mod Menu](https://modrinth.com/mod/modmenu) - 1.20.6 ✔ 1.21.4 ✔ 1.21.5 ✔
  - **Quality-of-life mod**
  - Adds an in-game list of every loaded mod and allows you to configure the settings of mods
- [Model Gap Fix](https://modrinth.com/mod/modelfix) - 1.20.6 ✔ 1.21.4 ✔ 1.21.5 ✔
  - **Quality-of-life mod**
...
- [Nvidum](https://modrinth.com/mod/nvidium) - 1.20.6 ✔ 1.21.4 ❌ 1.21.5 ❌ ([unofficial 1.21.5 version available here](https://github.com/drouarb/nvidium/releases)]
  ...
  - **Requires Sodium**
- [Reese's Sodium Options](https://modrinth.com/mod/reeses-sodium-options) - 1.20.6 ✔ 1.21.4 ✔ 1.21.5 ✔
  - **Quality-of-life mod**
...
- [Cloth Config API](https://modrinth.com/mod/cloth-config) - 1.20.6 ✔ 1.21.4 ✔ 1.21.5 ✔
  - **Dependency mod**
...
- [Indium](https://modrinth.com/mod/indium) - 1.20.6 ✔ 1.21.1 ✔ **(not necessary in Sodium 0.6 and above and Minecraft 1.21.3 and above)**
  - **Dependency mod**
...
- [MaLiLib](https://github.com/sakura-ryoko/malilib/releases) - 1.20.6 ✔ 1.21.4 ✔ 1.21.5 ✔ ([1.20.6 and other old versions linked here](https://www.curseforge.com/minecraft/mc-mods/malilib))
  - **Dependency mod**
  - Makes other mods by [the author of this mod](https://github.com/maruohon) work
- [TCDCommons API](https://modrinth.com/mod/tcdcommons) - 1.20.6 ✔ 1.21.4 ✔ 1.21.5 ✔
  - **Dependency mod**
  - An API for custom GUIs
  - **Requires Fabric API**
- [YetAnotherConfigLib](https://modrinth.com/mod/yacl) - 1.20.6 ✔ 1.21.4 ✔ 1.21.5 ✔
  - **Dependency mod**
  - Edit massive areas of terrain and make massive structures
  - **Requires Fabric API**
