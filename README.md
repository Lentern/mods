...
# Mods
* [3D Skin Layers](https://modrinth.com/mod/3dskinlayers) - 1.19.4 ✔ 1.20.1 ✔ 1.20.2 ✔
  * **Quality-of-life mod**
  * Makes the second layer of a skin render in 3D
* [Better Ping Display](https://modrinth.com/mod/better-ping-display-fabric) - 1.19.4 ✔ 1.20.1 ✔ 1.20.2 ✔
  * **Quality-of-life mod**
  * Changes player list (tab list) to show ping numbers instead of ping bars
* [Better Statistics Screen](https://modrinth.com/mod/better-stats) - 1.19.4 ✔ 1.20.1 ✔ 1.20.2 ✔
  * **Quality-of-life mod**
  * Makes the in-game statistics screen [beautiful](https://www.youtube.com/watch?v=AaC8J0G238c)
* [Blanket](https://modrinth.com/mod/blanket) - 1.19.4 ❌ 1.20.1 ✔ 1.20.2 ✔
...
* [Capes](https://modrinth.com/mod/capes/versions) - 1.19.4 ✔ 1.20.1 ✔ 1.20.2 ✔
  * **Quality-of-life mod**
  * Allows you to view your cape from mods like OptiFine
  * **Requires Fabric Language Kotlin & Quilted Fabric API**
* [Clear Skies](https://modrinth.com/mod/clear-skies) - 1.19.4 ✔ 1.20.1 ❌ 1.20.2 ❌
  * **Quality-of-life mod**
  * Fixes the skies of Minecraft to remove [banding](https://frederikboving.com/what-is-banding-in-photography/) at the horizon
* [Cloth Config API](https://modrinth.com/mod/cloth-config) - 1.19.4 ✔ 1.20.1 ✔ 1.20.2 ✔
  * **Dependency mod**
  * Required for a lot of mods to be configured
* [Continuity](https://modrinth.com/mod/continuity) - 1.19.4 ✔ 1.20.1 ✔ 1.20.2 ✔
  * **Quality-of-life mod**
  ...
  * **Requires Quilted Fabric API**
* [Dynamic FPS](https://modrinth.com/mod/dynamic-fps) - 1.19.4 ✔ 1.20.1 ✔ 1.20.2 ✔
  * **Performance mod**
...
* [Enhanced Block Entities](https://modrinth.com/mod/ebe) - 1.19.4 ✔ 1.20.1 ✔ 1.20.2 ✔
  ...
  * **Requires Quilted Fabric API**
* [Entity Culling](https://modrinth.com/mod/entityculling) - 1.19.4 ✔ 1.20.1 ✔ 1.20.2 ✔
  * **Performance mod**
  * Makes the game not render entites you can't see to improve FPS
  * **Requires Quilted Fabric API**
* [Fabric Language Kotlin](https://modrinth.com/mod/fabric-language-kotlin) - 1.19.4 ✔ 1.20.1 ✔ 1.20.2 ✔
  * **Dependency mod**
  * Adds support for Kotlin programming language for mods to use
* [FerriteCore](https://modrinth.com/mod/ferrite-core) - 1.19.4 ✔ 1.20.1 ✔ 1.20.2 ✔
  * **Performance mod**
  * Reduces the game's memory usage
* [FiveOneFourOneEight](https://modrinth.com/mod/fiveonefouroneeight) - 1.19.4 ✔ 1.20.1 ✔ 1.20.2 ✔ ([1.20+ download here](https://github.com/Lentern/FiveOneFourOneEight/releases/tag/v1.0.1))
  * **Quality-of-life mod**
...
* [ImmediatelyFast](https://modrinth.com/mod/immediatelyfast) - 1.19.4 ✔ 1.20.1 ✔ 1.20.2 ✔
  * **Performance mod**
  * Makes the game's FPS higher
* [In-Game Account Switcher](https://modrinth.com/mod/in-game-account-switcher) - 1.19.4 ✔ 1.20.1 ✔ 1.20.2 ✔
  * **Quality-of-life mod**
  * Allows you to switch between Minecraft account without restarting the game
  * **Requires Quilted Fabric API**
* [Indium](https://modrinth.com/mod/indium/versions) - 1.19.4 ✔ 1.20.1 ✔ 1.20.2 ✔
  * **Dependency mod**
...
* [Iris](https://modrinth.com/mod/iris) - 1.19.4 ✔ 1.20.1 ✔ 1.20.2 ✔
  * **Quality-of-life mod**
  * Adds support for shader packs, just like OptiFine
  * **Requires Sodium**
* [Krypton](https://modrinth.com/mod/krypton) - 1.19.4 ✔ 1.20.1 ✔ 1.20.2 ✔
  * **Performance mod**
  * Improves performance internally in [magical ways](https://github.com/astei/krypton/wiki)
* [Language Reload](https://modrinth.com/mod/language-reload) - 1.19.4 ✔ 1.20.1 ✔ 1.20.2 ✔
  * **Quality-of-life mod**
...
* [Lithium](https://modrinth.com/mod/lithium) - 1.19.4 ✔ 1.20.1 ✔ 1.20.2 ✔
  * **Performance mod**
  * Improves performance of features like mob AI, game physics, and more internal stuff without changing vanilla gameplay
* [Logical Zoom](https://modrinth.com/mod/logical-zoom) - 1.19.4 ✔ 1.20.1 ✔ 1.20.2 ✔
  * **Quality-of-life mod**
  * Adds OptiFine's zoom feature to the game without using OptiFine
  * [Ok Zoomer](https://modrinth.com/mod/ok-zoomer) offers more control over the zoom function, like animations. Note that it does not support Fabric, you must use Quilt - 1.19.4 ✔ 1.20.1 ✔ 1.20.2 ❌
  * **Both require Quilted Fabric API**
* [MaLiLib](https://www.curseforge.com/minecraft/mc-mods/malilib) - 1.19.4 ✔ 1.20.1 ✔ 1.20.2 ✔
  * **Dependency mod**
  * Makes other mods by [the author of this mod](https://github.com/maruohon) work
* [Memory Leak Fix](https://modrinth.com/mod/memoryleakfix) - 1.19.4 ✔ 1.20.1 ✔ 1.20.2 ❌
  * **Performance mod**
  * Fixes memory leaks
* [MiniHUD](https://www.curseforge.com/minecraft/mc-mods/minihud) - 1.19.4 ✔ 1.20.1 ✔ 1.20.2 ✔
  * **Quality-of-life mod**
  * Adds a mini F3 menu that you can add your own information to
  * **Requires MaLiLib**
* [MixinTrace](https://modrinth.com/mod/mixintrace) - 1.19.4 ✔ 1.20.1 ✔ 1.20.2 ✔
  * **Quality-of-life mod**
  * Makes crash reports more verbose
* [Mod Menu](https://modrinth.com/mod/modmenu) - 1.19.4 ✔ 1.20.1 ✔ 1.20.2 ✔
  * **Quality-of-life mod**
  * Adds an in-game list of every loaded mod and allows you to configure the settings of mods
* [More Chat History](https://modrinth.com/mod/morechathistory) - 1.19.4 ✔ 1.20.1 ✔ 1.20.2 ✔
  * **Quality-of-life mod**
  * Increases the maximum amount of chat messages you can see in your chat history from 100 to 16384
* [No Chat Reports](https://modrinth.com/mod/no-chat-reports) - 1.19.4 ✔ 1.20.1 ✔ 1.20.2 ✔
  * **Quality-of-life mod**
  * Removes signatures from your chat messages to make them unreportable and disables in-game telemetry (data collection)
* [No Telemetry](https://modrinth.com/mod/no-telemetry) - 1.19.4 ✔ 1.20.1 ✔ 1.20.2 ✔ **(not necessary if using No Chat Reports)**
  * **Quality-of-life mod**
  * If you don't want to use No Chat Reports, this mod disables telemetry without removing your chat signatures
* [Quilted Fabric API/Quilt Standard Libraries](https://modrinth.com/mod/qsl) - 1.19.4 ✔ 1.20.1 ✔ 1.20.2 ❌
  * **Dependency mod**
  * Makes most mods work
  * If using Fabric instead of Quilt, download [Fabric API](https://modrinth.com/mod/fabric-api) instead
* [Reese's Sodium Options](https://modrinth.com/mod/reeses-sodium-options) - 1.19.4 ✔ 1.20.1 ✔ 1.20.2 ✔
  * **Quality-of-life mod**
...
* [Sodium](https://modrinth.com/mod/sodium) - 1.19.4 ✔ 1.20.1 ✔ 1.20.2 ✔
  * **Performance mod**
...
* [Technopig](https://modrinth.com/mod/technomodel) - 1.19.4 ✔ 1.20.1 ✔ 1.20.2 ❌
  * **Great mod**
...
* [Unofficial Sodium Biome Blending Fix](https://modrinth.com/mod/unofficial-sodium-biome-blending-fix) - 1.19.4 ✔ 1.20.1 ❌ **(not necessary in Sodium 0.5 and above)**
  ...
  * **Requires Sodium**
* [WorldEdit](https://www.curseforge.com/minecraft/mc-mods/worldedit) - 1.19.4 ✔ 1.20.1 ✔ 1.20.2 ✔
  * **Quality-of-life mod**
